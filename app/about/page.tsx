...
export const metadata: Metadata = {
  ...
  description: "Elizabeth Agusti is a California LMFT offering online, trauma-informed psychotherapy for adults and couples. Her style is warm, attuned, and clinically grounded, with an emphasis on emotional safety, relational clarity, and measurable progress.",
};
...
export default function Page() {
  return (
    <>
      <PageHero
        title="About Elizabeth Agusti, LMFT"
        subtitle="Elizabeth Agusti is a California LMFT offering online, trauma-informed psychotherapy for adults and couples. Her style is warm, attuned, and clinically grounded, with an emphasis on emotional safety, relational clarity, and measurable progress."
      ...
      <section className="section-shell grid gap-5 pb-12 md:grid-cols-2">
        <article className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-slate-100">
          ...
          <p className="mt-3 text-slate-700">Clients often seek support for anxiety, trauma history, burnout, attachment wounds, and relationship strain.</p>
        </article>
        <article className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-slate-100">
