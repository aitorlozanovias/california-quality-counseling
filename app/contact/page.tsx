...
export const metadata: Metadata = {
  title: "Contact | Golden State Relationship & Trauma Therapy",
  description: "Use the secure contact form details below to request a consultation. I respond within one business day and will help you determine whether we are a good clinical fit.",
};
...
export default function Page() {
  return (
    <>
      <PageHero
        title="Contact and Consultation Request"
        subtitle="Use the secure contact form details below to request a consultation. I respond within one business day and will help you determine whether we are a good clinical fit."
