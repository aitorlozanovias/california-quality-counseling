...
export const metadata: Metadata = {
  title: "EMDR Therapy | Golden State Relationship & Trauma Therapy",
  description: "EMDR helps your brain process distressing memories so they feel less overwhelming. Sessions are paced to your nervous system, building stability first and then targeting experiences that continue to trigger anxiety, shame, or fear.",
};
...
export default function Page() {
  return (
    <>
      <PageHero
        title="EMDR Therapy for Trauma Recovery"
        subtitle="EMDR helps your brain process distressing memories so they feel less overwhelming. Sessions are paced to your nervous system, building stability first and then targeting experiences that continue to trigger anxiety, shame, or fear."
