...
export const metadata: Metadata = {
  title: "Fees & Insurance | Golden State Relationship & Trauma Therapy",
  description: "Therapy should feel accessible and predictable. I offer clear session rates, superbills for out-of-network reimbursement, and practical guidance to help you use your mental health benefits effectively.",
};
...
export default function Page() {
  return (
    <>
      <PageHero
        title="Simple, Transparent Fees and Insurance Support"
        subtitle="Therapy should feel accessible and predictable. I offer clear session rates, superbills for out-of-network reimbursement, and practical guidance to help you use your mental health benefits effectively."
