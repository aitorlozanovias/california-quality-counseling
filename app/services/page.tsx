...
export const metadata: Metadata = {
  title: "Services | Golden State Relationship & Trauma Therapy",
  description: "Every treatment plan is collaborative, trauma-informed, and tailored to your goals. Services include EMDR for trauma recovery, couples therapy for connection and conflict repair, and individual therapy for anxiety, depression, and life transitions.",
};
...
export default function Page() {
  return (
    <>
      <PageHero
        title="Therapy Services for California Adults, Couples, and Families"
        subtitle="Every treatment plan is collaborative, trauma-informed, and tailored to your goals. Services include EMDR for trauma recovery, couples therapy for connection and conflict repair, and individual therapy for anxiety, depression, and life transitions."
