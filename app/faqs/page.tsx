...
export const metadata: Metadata = {
  ...
  description: "Answers below cover telehealth scope, scheduling, payment, and fit so you can make an informed decision before starting therapy.",
};
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Answers below cover telehealth scope, scheduling, payment, and fit so you can make an informed decision before starting therapy."
      ...
      <section className="section-shell grid gap-5 pb-12 md:grid-cols-2">
        <article className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-slate-100">
          ...
          <p className="mt-3 text-slate-700">Consultation calls are available to review goals and discuss whether this practice is the right fit.</p>
        </article>
        <article className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-slate-100">
