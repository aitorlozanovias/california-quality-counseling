...
export const metadata: Metadata = {
  title: "Couples Therapy | Golden State Relationship & Trauma Therapy",
  description: "Couples therapy provides a structured space to break repetitive conflict cycles, express needs clearly, and rebuild emotional safety. We focus on practical communication skills and deeper relational repair.",
};
...
export default function Page() {
  return (
    <>
      <PageHero
        title="Couples Therapy for Communication and Reconnection"
        subtitle="Couples therapy provides a structured space to break repetitive conflict cycles, express needs clearly, and rebuild emotional safety. We focus on practical communication skills and deeper relational repair."
