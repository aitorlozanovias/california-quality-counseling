...
export const metadata: Metadata = {
  ...
  description: "Couples sessions focus on interrupting repetitive conflict loops, strengthening communication, rebuilding trust, and improving emotional responsiveness.",
};
...
export default function Page() {
  return (
    <>
      <PageHero
        title="Couples Therapy for Repair and Reconnection"
        subtitle="Couples sessions focus on interrupting repetitive conflict loops, strengthening communication, rebuilding trust, and improving emotional responsiveness."
      ...
      <section className="section-shell grid gap-5 pb-12 md:grid-cols-2">
        <article className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-slate-100">
          ...
          <p className="mt-3 text-slate-700">Work is structured and collaborative, with concrete tools you can use between sessions.</p>
        </article>
        <article className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-slate-100">
